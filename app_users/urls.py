...
urlpatterns = [
    ...
    path(
        "invalid_verify/",
        TemplateView.as_view(template_name="app_users/profile/invalid_verify.html"),
        name="invalid_verify",
    ),
    path("verify_email/<uidb64>/<token>/", EmailVerify.as_view(), name="verify_email"),
    path(
        "confirm_email/",
        TemplateView.as_view(template_name="app_users/profile/confirm_email.html"),
        name="confirm_email",
    ),
    ...
    path(
        ...
        name="password_and_security",
    ),
    path("profile/balance/", balance, name="balance"),
    path(
        "profile/balance/shareholders-book/",
        shareholders_book,
        name="shareholders_book",
    ),
    ...
    path(
        "frelancers/<slug:frelancer_username>/", Frelancer.as_view(), name="frelancer"
    ),
]
