...
class CustomUserChangeForm(UserChangeForm):
    username = forms.SlugField(
        ...
        widget=forms.TextInput(
            attrs={
                ...
                "placeholder": _(
                    "Придумайте псевдоним, который будет отображаться на страницах сайта"
                ),
                "maxlength": "55",
            }
        ),
    ...
    personal_number = forms.CharField(
        max_length=17,
        label=_("ИНН или персональный номер"),
        required=False,
        widget=forms.TextInput(
            attrs={
                "data-validate": "require",
    ...
    document_number = forms.CharField(
        max_length=55,
        label=_("Серия и номер документа"),
        required=False,
        widget=forms.TextInput(
            attrs={
                "data-validate": "require",
    ...
    document_issued = forms.CharField(
        max_length=255,
        label=_("Когда и кем выдан"),
        required=False,
        widget=forms.TextInput(
            attrs={
                "data-validate": "require",
    ...
    bank_correspondent_account = forms.CharField(
        max_length=55,
        label=_("Корреспондентский счет банка"),
        required=False,
        widget=forms.TextInput(
            attrs={
                "data-validate": "require",
    ...
    recipients_name = forms.CharField(
        max_length=255,
        label=_("Имя получателя платежа"),
        required=False,
        widget=forms.TextInput(
            attrs={
                "data-validate": "require",
